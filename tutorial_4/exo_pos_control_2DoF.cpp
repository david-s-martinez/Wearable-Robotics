...
namespace ExoControllers{
    ...
    {
        MatrixXd Yr(2,8);   //to DO,)
        MatrixXd Theta(8,1);//to DO,1);

        Yr(0,0) = qdd1r;
        Yr(0,1) = 0;
        Yr(0,2) = q1 - m_theta1; //to Do!
        Yr(0,3) = 0;
        Yr(0,4) = (m_gy*cos(q1)-m_gx*sin(q1))/2;
        Yr(0,5) = 0;
        Yr(0,6) = qd1r;
        Yr(0,7) = 0;
        ...
        Yr(1,1) = qdd2r;
        Yr(1,2) = 0;
        Yr(1,3) = q2 - m_theta2; //to Do!
        Yr(1,4) = 0;
        Yr(1,5) = sin(q2)*(m_gx*cos(q1)+m_gy*sin(q1))+m_gz*cos(q2);
        Yr(1,6) = 0;
        Yr(1,7) = qd2r;
        ...
        Theta(1,0) = m_I333 + pow(m_L3,2)*m_m3/4; // to Do
        Theta(3,0) = m_k2;
        Theta(5,0) = -m_L3*m_m3/2;
        Theta(7,0) = m_b2;
